package com.again.micro.component.kafka.builder;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.util.StrUtil;
import com.again.micro.component.kafka.KafkaConstants;
import com.again.micro.component.kafka.KafkaExtendProducer;
...
public class KafkaProducerBuilder {
	...
	public KafkaProducerBuilder clientId(String clientId) {
		return put(ProducerConfig.CLIENT_ID_CONFIG, clientId);
	}

	/**
	 * 添加 kafka 路径 host:port
	 *
	 * lyj 2020-06-19 16:30:03
	 */
